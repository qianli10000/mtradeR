...
JMR_core<-function(taxa,others_abun,others_pres,long_design,logistic_design,outcome,long_idset,logistic_idset,rand.var,shrinkage,trace=T,n.cores=NULL){
  ...
  m=optimParallel::optimParallel(par.ini,llh_match,taxa=taxa,others_abun=others_abun,others_pres=others_pres,long_design=long_design,logistic_design=logistic_design,outcome=outcome,long_idset=long_idset,logistic_idset=logistic_idset,rand.var=rand.var,shrinkage=shrinkage,
